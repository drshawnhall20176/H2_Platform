...
def build_matchup_profile(row: Dict, h2h_log: List[Dict], opp_recent_allowed: Dict[str, float],
    ...
    different design). One NBA-specific note: h2h_log can legitimately be empty or small even
    mid-season — NBA teams play each other 2, 3, or 4 times a season depending on conference/
    division, not the uniform "meet 2-4 times" WNBA's balanced schedule produces, so a genuinely
    small H2H sample is common and expected here too, reported honestly rather than padded."""
