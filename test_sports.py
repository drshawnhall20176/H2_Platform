...
def test_owner_only_pages_match_expected_titles():
    ...
    # Board, Matchup Lab, Track Record, and Data Health must stay in the owner-only gate, and the
    # gate must resolve against real page titles that exist in _META (a typo here would silently
    # fail to hide a page from the public build).
    ...
    assert gated == {"Bet Log", "Media Room", "Podcast Studio", "Edge Board",
                     "Matchup Lab", "Track Record", "Data Health"}, gated
    ...
    print("✓ owner-only gate targets exactly Bet Log / Media Room / Podcast Studio / Edge Board / "
          "Matchup Lab / Track Record / Data Health, by real title")
