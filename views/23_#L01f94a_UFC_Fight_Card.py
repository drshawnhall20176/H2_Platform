"""
UFC Fight Card — tonight's bouts with odds, method of victory lines, and
fight duration. Phase 1: data surface only, no model. Community members
pick fighters; the page shows the odds context and implied probabilities
so picks are grounded rather than pure gut.
...
- Method of victory odds (KO/TKO, Submission, Decision)
...
st.caption("📊 Odds from The Odds API — same source as MLB/NFL Edge Board. "
           ...
           "Method of victory and fight duration markets may not be available on all "
           "subscription tiers. Phase 2 will add finishing rate history and conviction "
           "scoring against the community's own pick distribution.")
