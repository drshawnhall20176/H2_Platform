...
def load_injuries(date_str: str, team_abbrs_tuple: tuple):
    ...
    # here used to run independently, cached under THIS page's own function identity -- NFL
    # Matchup Lab cached the exact same real chain separately too. See nfl_shared_cache.py's own
